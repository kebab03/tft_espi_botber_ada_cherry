...
//drawButton("god");
myGLCD.fillRect(16,16,108,176,0);
myGLCD.fillRect(56,76,28,4,TFT_BLUE);
myGLCD.fillRect(92,76,28,4,TFT_BLUE);
myGLCD.fillRect(44,80,72,4,TFT_BLUE);
myGLCD.fillRect(36,84,80,4,TFT_BLUE);
myGLCD.fillRect(32,88,84,4,TFT_BLUE);
myGLCD.fillRect(28,92,28,4,TFT_BLUE);
myGLCD.fillRect(80,92,36,4,TFT_BLUE);
myGLCD.fillRect(24,96,24,4,TFT_BLUE);
myGLCD.fillRect(88,96,28,4,TFT_BLUE);
myGLCD.fillRect(24,100,20,4,TFT_BLUE);
myGLCD.fillRect(88,100,28,4,TFT_BLUE);
myGLCD.fillRect(20,104,24,4,TFT_BLUE);
myGLCD.fillRect(92,104,24,4,TFT_BLUE);
myGLCD.fillRect(20,108,20,4,TFT_BLUE);
myGLCD.fillRect(92,108,24,4,TFT_BLUE);
myGLCD.fillRect(20,112,20,4,TFT_BLUE);
myGLCD.fillRect(92,112,24,4,TFT_BLUE);
myGLCD.fillRect(20,116,20,4,TFT_BLUE);
myGLCD.fillRect(92,116,24,4,TFT_BLUE);
myGLCD.fillRect(20,120,20,4,TFT_BLUE);
myGLCD.fillRect(92,120,24,4,TFT_BLUE);
myGLCD.fillRect(20,124,24,4,TFT_BLUE);
myGLCD.fillRect(88,124,28,4,TFT_BLUE);
myGLCD.fillRect(24,128,24,4,TFT_BLUE);
myGLCD.fillRect(84,128,32,4,TFT_BLUE);
myGLCD.fillRect(24,132,32,4,TFT_BLUE);
myGLCD.fillRect(76,132,40,4,TFT_BLUE);
myGLCD.fillRect(28,136,88,4,TFT_BLUE);
myGLCD.fillRect(32,140,84,4,TFT_BLUE);
myGLCD.fillRect(40,144,44,4,TFT_BLUE);
myGLCD.fillRect(92,144,24,4,TFT_BLUE);
myGLCD.fillRect(48,148,28,4,TFT_BLUE);
myGLCD.fillRect(92,148,24,4,TFT_BLUE);
myGLCD.fillRect(92,152,24,4,TFT_BLUE);
myGLCD.fillRect(92,156,24,4,TFT_BLUE);
myGLCD.fillRect(88,160,28,4,TFT_BLUE);
myGLCD.fillRect(40,164,4,4,TFT_BLUE);
myGLCD.fillRect(80,164,32,4,TFT_BLUE);
myGLCD.fillRect(40,168,68,4,TFT_BLUE);
myGLCD.fillRect(40,172,64,4,TFT_BLUE);
myGLCD.fillRect(40,176,56,4,TFT_BLUE);
myGLCD.fillRect(40,180,44,4,TFT_BLUE);
